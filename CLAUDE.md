...
- **Section rhythm is `py-16 sm:py-20 lg:py-24`.** Padding stacks at a boundary, so the visible gap between two sections is double the value — `lg:py-40` looked reasonable per section but produced a 320px void at every join, leaving 20% of the page blank.
